...
a = load(['results_current/tmp_results_' with_replan '/weig_human_motion_' with_replan '_user_study.mat']);
w = squeeze(a.recovered_weights);
filename = [weights_tmp 'user_study_' with_replan '_spheres_weights_300.txt'];
