...
def run_test(name, parameter_filename_tmp, args):
    ...
    p3d_file = "../assets/Collaboration/TwoHumansTableMocap.p3d"
    sce_file = "../assets/Collaboration/SCENARIOS/collaboration_aterm.sce"
...
def run_move3d(move3d, function, return_dict):
    ...
    parameter_filename = "params_collaboration_planning_aterm"
